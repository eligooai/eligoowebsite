...
const page: PageContent = {
  ...
  sections: [
    ...
    faq([
      ...
      { q: 'Who is in control?', a: 'You. Objectives come from you, outward actions wait for your approval, every employee has a defined boundary, and the activity log shows every decision. Employees wait when blocked rather than improvising.' },
