...
const page: PageContent = {
  ...
  sections: [
    ...
    faq([
      ...
      { q: 'How many calls can it make?', a: 'Campaigns run one call at a time per line at the pace you set, inside the window you set, and roll over unfinished contacts to the next day. Calling is included on plans that list it; telephony is billed by your trunk provider and model usage by your AI provider, on your own accounts.' },
