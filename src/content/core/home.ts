...
const page: PageContent = {
  ...
  sections: [
    ...
    { kind: 'pricing', heading: 'Plans', intro: 'A platform subscription priced per workspace; model usage runs on your own AI keys, billed by the provider with no markup. Live plans are pulled from the platform, so what you see here is what you get.' },
    faq([
      ...
      { q: 'Is my data separated from other customers?', a: 'Each customer has its own workspace with its own data, connections, AI keys and settings. The security page explains how keys and data are handled.' },
    ]),
