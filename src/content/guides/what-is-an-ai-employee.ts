...
const page: PageContent = {
  ...
  sections: [
    ...
    faq([
      ...
      { q: 'How much does an AI employee cost?', a: 'Eligoo is a flat platform subscription priced per workspace, plus your own model usage billed by your AI provider on your own key, with no markup. Current plans and a free trial are on the pricing page.' },
